        ...
        <ul class="space-y-2">
            ...
            <li>
                <a
                    ...
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
                    <i class="w-6 h-6 text-center fa-solid fa-blog text-gray-500 dark:text-white"></i>
            ...
            <li>
                <a
                    href="{{route('logout')}}"
                    class="flex items-center p-2 text-base font-medium rounded-lg bg-red-600 text-white hover:bg-red-700 dark:hover:bg-red-700 group"
                >
                    <i class="w-6 h-6 text-center fa-solid fa-blog text-white"></i>
                    <span class="ml-3">Logout</span>
                </a>
            </li>
{{--            <li>--}}
{{--                <a--}}
{{--                    href="{{route('dashboard.pendaftaran.index')}}"--}}
{{--                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"--}}
{{--                >--}}
{{--                    <i class="w-6 h-6 text-center fa-solid fa-user-plus text-gray-500"></i>--}}
